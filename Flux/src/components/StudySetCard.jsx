    ...
    <div className={`study-card group animate-fade-in ${wide ? 'md:col-span-2' : ''}`}>
      ...
      <div className="mt-6 flex gap-2">
        ...
        <Link
          ...
          className={`flex ${set.lastStudied ? 'flex-[2]' : 'w-full'} items-center justify-center gap-1.5 py-2.5 rounded-md bg-surface-container-high text-primary text-sm font-bold font-headline hover:bg-primary hover:text-on-primary transition-all duration-200`}
          onClick={e => e.stopPropagation()}
        >
